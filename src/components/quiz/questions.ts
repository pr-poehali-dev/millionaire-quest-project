...
export const questions: Question[] = [
  ...
  { 
    id: 12, 
    question: "Сопоставь элементы осциллографа с их функциями:", 
    answers: [],
    correct: 0,
    type: 'matching',
    matchingPairs: {
    ...
    hint: "Подумай о назначении: яркость — интенсивность луча, фокус — четкость, синхронизация — стабильность изображения, развертка — время"
  }
];